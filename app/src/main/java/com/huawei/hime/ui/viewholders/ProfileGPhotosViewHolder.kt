...
class ProfileGPhotosViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView),
    ViewHolderContract {
    ...
    private var mPostContent: ImageView? = null
    ...
    init {
        ...
        circleMenu.visibility = View.INVISIBLE
