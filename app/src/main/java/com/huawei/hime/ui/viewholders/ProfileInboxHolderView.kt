...
class ProfileInboxHolderView(itemView: View) : RecyclerView.ViewHolder(itemView) {

    val parent: View? = itemView

    private var chatBetween: TextView? = null

    fun bindBetween(between: String) {
        chatBetween!!.text = between
    }
    ...
    init {
        chatBetween = parent!!.findViewById(R.id.chatBetweenText)
