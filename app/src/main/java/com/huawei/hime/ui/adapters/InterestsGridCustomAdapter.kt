...
data class InterestsGridCustomAdapter(var imgList: List<InterestsType>, var activity: InterestsActivity) :
    BaseAdapter() {
    @SuppressLint("ViewHolder")
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        val view: View = View.inflate(activity, R.layout.single_interests_card, null)
        val tvExp = view.findViewById(R.id.single_interest_txt) as TextView
